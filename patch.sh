...
sed -i '/#define	NET_PROTO_LACP/a #define  NET_PROTO_LLDP          /* LLDP protocol */'        ipxe/src/config/general.h
...
sed -i '/#define DHCP_EB_FEATURE_NFS/a #define DHCP_EB_FEATURE_LLDP 0x30 /**< LLDP protocol */' ipxe/src/include/ipxe/features.h
